...
public class ImageAdapter$ViewHolder$$ViewBinder<T extends ImageAdapter.ViewHolder> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ImageAdapter.ViewHolder> implements Unbinder {
    private T target;
