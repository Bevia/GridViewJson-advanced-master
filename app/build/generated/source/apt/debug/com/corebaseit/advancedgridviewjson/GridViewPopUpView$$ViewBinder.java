...
public class GridViewPopUpView$$ViewBinder<T extends GridViewPopUpView> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends GridViewPopUpView> implements Unbinder {
    private T target;
