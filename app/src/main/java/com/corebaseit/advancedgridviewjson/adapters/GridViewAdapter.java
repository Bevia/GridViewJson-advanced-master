...
import com.corebaseit.advancedgridviewjson.GridViewPopUpView;
...
public class GridViewAdapter extends ArrayAdapter<ElsPoetesJsonDataModel> {
    ...
    public GridViewAdapter(Context context, List<ElsPoetesJsonDataModel> objects) {
    ...
    public void datos(int position) {
        ...
        Intent intent = new Intent(context, GridViewPopUpView.class);
